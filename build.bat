...
set CONTRACT_JS=%SOURCE_CODE_DIR%\blogger\relatedposts\contract.js
set OUTPUT_FILE=.\build\blogger.relatedposts.min.js
...
echo /** Copyright (c) 2015 akinari tsugo */>tmp.txt
